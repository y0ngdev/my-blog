  ...
  <div class="container mx-auto py-16 lg:py-24">
    ...
    <div class="mx-auto w-full max-w-sm">
      <form class="mt-8 flex flex-col gap-3 lg:mt-12 lg:flex-row lg:items-center">
        ...
        <div>
          <Button class="w-full whitespace-nowrap lg:w-auto" type="submit">Get started</Button>
        </div>
      </form>
      ...
      <div class="w-full border-t border-white/10 bg-black/40 p-10 text-white backdrop-blur-2xl">
        ...
        <div class="mt-5 flex flex-wrap items-center gap-2">
          <template v-for="t in ['Design', 'Research', 'Presentation']" :key="t">
            <Badge class="border-white px-3 py-1 text-sm text-white" variant="outline">{{
                t
              }}
            </Badge>
          </template>
    ...
    <div class="mb-10 mt-16 lg:hidden">
      ...
      <div class="flex flex-wrap items-center gap-2">
        <template v-for="t in tags" :key="t">
          <Badge class="px-3 py-1 text-sm" variant="outline">{{ t }}</Badge>
        </template>
      </div>
    </div>
